...
-- AI readiness audit intakes (auth-only, owner CRUD)
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.audit_intakes TO authenticated;
GRANT ALL ON public.audit_intakes TO service_role;
ALTER TABLE public.audit_intakes ENABLE ROW LEVEL SECURITY;
CREATE POLICY "own intakes" ON public.audit_intakes FOR ALL TO authenticated
